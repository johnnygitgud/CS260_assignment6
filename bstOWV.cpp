//This file is name bstOWV because it is the the Binary Search Tree Orginal Working Version. 
//It is the version that ran entirely on just one file where each method was successfully demontsrated.
...
//First basic attempt at basic testing of each component.
int main() {
    FileBST fileTree;
